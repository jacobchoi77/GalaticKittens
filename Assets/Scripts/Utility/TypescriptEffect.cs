    ...
    */
    private IEnumerator Effect(){
        while (true){
            ...
            var initialScale = new Vector2(1, 1); // The initial scale of the object
            var scaleValues = initialScale; // Vector 2 for the new scale
            ...
            while (curveDeltaTime <= _scaleAnimationTime){
                ...
                var scaleCurve = _scaleCurve.Evaluate(curveDeltaTime);
